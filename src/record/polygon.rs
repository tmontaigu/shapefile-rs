...
mod test_geo_types {
    ...
    #[test]
    fn shapefile_polygon_to_geotypes_polygon_outer_inner_outer() {

        let triple_ring_polygon = Polygon::with_rings(vec![
            PolygonRing::Outer(vec![
                Point::new(-1.1,-1.01),
                Point::new(-1.2, 1.02),
                Point::new( 1.3, 1.03),
                ...
                Point::new(-0.251,-0.2501),
                Point::new(-0.252, 0.2502),
                Point::new( 0.253, 0.2503),
                Point::new( 0.254,-0.2504),
                Point::new(-0.251,-0.2501),
        ])]);
        
        let converted_multipolygon = geo_types::MultiPolygon::<f64>::from(triple_ring_polygon);
    ...
    #[test]
    fn geotypes_polygon_to_shapefile_polygon_outer_inner_outer() {
    ...
    #[test]
    fn shapefile_polygon_to_geotypes_polygon_exclave() {
        ...
        let one_ring_polygon = Polygon::with_rings(vec![
            PolygonRing::Outer(vec![
                ...
                Point::new(10.0 - 0.51, 10.0 - 0.501),
                Point::new(10.0 - 0.52, 10.0 + 0.502),
                Point::new(10.0 + 0.53, 10.0 + 0.503),
                Point::new(10.0 + 0.54, 10.0 - 0.504),
                Point::new(10.0 - 0.51, 10.0 - 0.501),
        ])]);
        ...
        let expected_geotypes_polygon = geo_types::Polygon::new(
            ...
            vec![LineString::from(vec![
                (10.0 - 0.51, 10.0 - 0.501),
                (10.0 - 0.52, 10.0 + 0.502),
                (10.0 + 0.53, 10.0 + 0.503),
                (10.0 + 0.54, 10.0 - 0.504),
                (10.0 - 0.51, 10.0 - 0.501),
            ])],
        );
    ...
    #[test]
    fn geotypes_polygon_to_shapefile_polygon_exclave() {
